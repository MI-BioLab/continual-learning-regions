...
"""
Base class for the clustering, specialized in ClusteringFromGraph and ClusteringFromGroundtruth.
"""
class BaseClustering:
    ...
    """
    Method to connect the nodes of the current sequence with the nodes of previous sequences already explored.
    """
    ...
    """
    Function to update the clustering connections and params before assign the new node.
    """
    ...
    """
    Base method, specialized in ClusteringFromGraph and ClusteringFromGroundtruth.
    """
    def clusterize_next_node(self, dynamic=True):
        self.just_moved = dict()
    
    """
    Align sequence assigning node to the closest one in the KDTree. Used to align test sequences to train sequences.
    """
        ...
        for i in range(len(self.nodes)):
            ...
            if self.kdtree is not None:
                ...
                distances, indices = self.kdtree.query(node.position, 
                                                        k=1, 
                                                        # distance_upper_bound=self.max_distance_for_link,
                                                        workers=4
                                                        )
    ...
    """
    Update params at the end of each sequence.
    """
    ...
    """
    Method which performs the dynamic clustering.
    """
