...
"""
Dataset to load images and assign the corresponding label.
This dataset is used to pass the images through the network and extract features until the latent replay layer.
"""
