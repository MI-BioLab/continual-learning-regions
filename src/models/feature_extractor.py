...
"""
Return the resnet pretrained on Places365.
"""
...
class FeatureExtractor(nn.Module):
    ...
    """
    Extract features until latent replay layer, which is the freezed part of the CNN.
    """
    @torch.jit.export
    ...
    """
    Extract features after latent replay layer, which is the trainable part of the CNN.
    """
    @torch.jit.export
