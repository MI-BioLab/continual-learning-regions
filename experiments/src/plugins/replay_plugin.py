        ...
        **kwargs
        ...
        if globals.debug:
            with open(globals.debug_file, "a") as file:
                file.write(f"Replay dataloader created\n")
       
    @profile(stream=globals.memory_profiler_file)
    def after_training_exp(self, strategy: "SupervisedTemplate", **kwargs):
        #TODO maybe can be useful set strategy.experience.dataset = strategy.adapted_dataset and then use .update instead of .update_from_dataset
        strategy.experience.dataset = strategy.adapted_dataset
        self.storage_policy.update(strategy, **kwargs)
        if globals.debug:
            with open(globals.debug_file, "a") as file:
                file.write(f"Replay memory updated\n")
